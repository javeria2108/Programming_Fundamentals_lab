        ...
        if str.isalpha(letters_guessed)==False:
            if warnings>0:
               ...
               print('Oops!that is not a valid letter. You have ',warnings,'warnings left',get_guessed_word(secret_word, guess))
                ...
                remaining_guesses-=1
                warnings=3
                print ('Oops, that is not a valid letter.You have no warnings left so you lose one guess. You have ',remaining_guesses,'guesses left',get_guessed_word(secret_word, guess))
        else:
            ...
            if 2*letters_guessed in guess:
                if warnings>0:
                    ...
                    print ('You have already guessed that letter. You have',warnings,'warnings left' )
                         ...
                         remaining_guesses-=1
                         warnings=3
                         print('You have already guessed that letter.You have no warnings left so you lose one guess. You have',remaining_guesses,'guesses left')    
